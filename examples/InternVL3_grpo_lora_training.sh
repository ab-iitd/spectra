...
project_name=InternVL3_8B_RL
experiment_name=InternVL3_8B_RL
default_local_dir=/verl/spectra/$experiment_name

# =================== logging ===================
EXPERIMENT_NAME="InternVL3_8B_RL_full_eval_$(now)"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/""Your Model Path""/InternVL3-8B-Instruct \
    ...
    trainer.experiment_name='intern_vl_8b_function_rm2' \
    trainer.n_gpus_per_node=2 \
    trainer.val_before_train=True \
    trainer.log_val_generations=5 \
    trainer.critic_warmup=20 \
    trainer.nnodes=1 \
    trainer.rollout_data_dir=/verl/spectra/Intern_VL/Training_op \
    trainer.validation_data_dir=/verl/spectra/Intern_VL/Validation_op \
